    ...
    @for ($i = 1; $i <= $max; $i++)
        @if ($i <= floor($rating))
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" height="25"
                width="25"><!--!Font Awesome Free v7.0.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                <path fill="#FFD43B"
