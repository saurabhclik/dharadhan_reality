                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div class="space-y-1">
                                ...
                                <input type="text" name="title" id="title" autofocus
                                    value="{{ old('title') }}" placeholder="{{ __('Enter video title') }}"
                                    class="form-control">
                            </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="url" name="youtube_url" id="youtube_url" required value="{{ old('youtube_url') }}"
                            ...
                            <div class="space-y-1">
                                ...
                                <select name="position" id="position" required class="form-control">
                                    <option value="center" {{ old('position') === 'center' ? 'selected' : '' }}>
                                        {{ __('Center (Main)') }}</option>
                                    <option value="left" {{ old('position') === 'left' ? 'selected' : '' }}>
                                        {{ __('Left Sidebar') }}</option>
                                    <option value="right" {{ old('position') === 'right' ? 'selected' : '' }}>
                            ...
                            {!! ld_apply_filters('after_video_fields', '', null) !!}
                        </div>
