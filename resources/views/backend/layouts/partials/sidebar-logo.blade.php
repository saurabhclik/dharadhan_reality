<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[85px] app-sidebar-minified' : '-translate-x-full'"
    ...
    <!-- Sidebar Header -->
    <div :class="sidebarToggle && !isHovered ? 'justify-center' : 'justify-between'" style="justify-content: center;"
        class="flex items-center gap-2 sidebar-header py-5 px-6 h-[100px] transition-all duration-300">
