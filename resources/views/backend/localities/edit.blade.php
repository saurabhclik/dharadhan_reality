    ...
    <div class="space-y-6">
        <div class="rounded-md border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="p-5 space-y-6 border-t border-gray-100 dark:border-gray-800 sm:p-6">
                <form action="{{ route('admin.localities.update', $locality->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="name" value="{{ old('name', $locality->name) }}" class="form-control" 
                        ...
                        <div class="space-y-1">
                            ...
                            <select name="category" class="form-control" required>
                                @foreach($categories as $value => $label)
                                    <option value="{{ $value }}" {{ old('category', $locality->category) == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="number" name="sort_order" value="{{ old('sort_order', $locality->sort_order) }}" class="form-control">
                        ...
                        <div class="space-y-1">
                            <div class="flex items-center gap-2 mt-2">
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $locality->is_active) ? 'checked' : '' }} class="form-checkbox">
