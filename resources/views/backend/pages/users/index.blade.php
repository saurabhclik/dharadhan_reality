                        ...
                        <thead class="bg-light text-capitalize">
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                ...
                                <th width="20%" class="p-2 bg-gray-50 dark:bg-gray-800 dark:text-white text-left px-5">
                                    <div class="flex items-center">
                                        {{_('Phone')}}
                                        <a href="{{ request()->fullUrlWithQuery(['sort' => request()->sort === 'phone' ? '-phone' : 'phone'])}}" class="ml-1">
                        ...
                        <tbody>
                            @forelse ($users as $user)
                                <tr
                                    ...
                                    <td class="px-5 py-4 sm:px-6">{{ $user->utr_number ?? "-" }}</td>
                                    <td class="px-5 py-4 sm:px-6">
                                    ...
                                    <td class="px-5 py-4 sm:px-6">{{ucfirst($user->plan_type) }}</td>
