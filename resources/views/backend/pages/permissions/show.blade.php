            ...
            <div class="rounded-md border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="border-t border-gray-100 dark:border-gray-800 p-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <div class="mb-4">
                                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-300">{{ __('Permission Name') }}
                                </h4>
                                <p class="mt-1 text-lg font-medium text-gray-700 dark:text-white">{{ $permission->name }}</p>
                            </div>
                            <div>
                                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-300">{{ __('Permission Group') }}
                                </h4>
                                <p class="mt-1">
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-gray-500 dark:text-gray-300 mb-2">{{ __('Assigned Roles') }}
                            </h4>
                            @if ($roles->count() > 0)
                                <div class="space-y-2">
                            ...
                            @else
                                <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-md text-center">
                                    <span
                                        class="text-gray-500 dark:text-gray-300">{{ __('No roles have this permission') }}</span>
                                </div>
                            @endif
                        </div>
                    </div>
