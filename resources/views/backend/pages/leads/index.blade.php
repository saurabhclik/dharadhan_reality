                                            ...
                                            @can('lead.transfer')
                                                <div x-data="{ transferModalOpen: false }">
                                                    <x-buttons.action-item
                                                        type="modal-trigger"
                                                        modal-target="transferModalOpen"
                                                        icon="repeat"
                                                        :label="__('Transfer')"
                                                    />
                                                    ...
                                                    <div x-show="transferModalOpen"
                                                        ...
                                                        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-md">
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('admin.leads.transfer', $lead->id) }}">
                                                                @csrf
                                                                ...
                                                                <select name="transfer_user_id" required
                                                                    class="w-full rounded-lg border-gray-300 dark:bg-gray-900 select2">
                                                                    <option value="">-- Select User --</option>
                                                                    @foreach ($users as $user)
                                                                        <option value="{{ $user->id }}"
                                                                            @selected($lead->transfer_user_id == $user->id)>
                                                                            {{ $user->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
