...
@section('admin-content')
    ...
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6" x-data="{ showUploadArea: false }" x-init="showUploadArea = {{ count($modules) > 0 ? 'false' : 'true' }}" x-cloak
        x-on:keydown.escape.window="showUploadArea = false" x-on:click.away="showUploadArea = false">
                        ...
                        <div class="w-[300px] p-4 font-normal">
                            ...
                            <ul class="list-disc pl-5 space-y-1 text-sm">
                                ...
                                <li>
                                    ...
                                    <a href="https://laradashboard.com/docs/how-to-create-a-module-in-lara-dashboard/"
        ...
        @if (!empty($modules))
            <div x-show="showUploadArea"
                ...
                <p class="text-center text-gray-600 dark:text-gray-300">
                    ...
                    <button @click="$refs.uploadModule.click()" class="text-primary underline hover:text-blue-600">
                        {{ __('browse') }}
                    </button>
                    {{ __('to select a file.') }}
                </p>
        ...
        <div class="space-y-6">
            @if (empty($modules))
                <div class="flex flex-col items-center justify-center h-64 bg-gray-100 dark:bg-gray-800 rounded-md border-2 border-dashed border-gray-300"
                    ...
                    <p class="mt-4 text-gray-600 dark:text-gray-300">{{ __('Drag and drop your module file here, or') }}
                    </p>
                    ...
                    @foreach ($modules as $module)
                        <div tabindex="0"
                            ...
                            <div class="flex justify-between" x-data="{ deleteModalOpen: false, errorModalOpen: false, errorMessage: '' }">
                                ...
                                <button id="dropdownMenuIconButton" data-dropdown-toggle="dropdownMore-{{ $module->name }}"
                                    class="inline-flex items-right h-9 p-2 text-sm font-medium text-center text-gray-700 bg-white rounded-md hover:bg-gray-100 focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                                    type="button">
                                    <iconify-icon icon="lucide:more-vertical"></iconify-icon>
                                </button>

                                <div id="dropdownMore-{{ $module->name }}"
                                    class="z-10 hidden bg-white divide-y divide-gray-100 rounded-md shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                        aria-labelledby="dropdownMenuIconButton">
                                        <li>
                                            <div>
                                                <button x-on:click="deleteModalOpen = true"
                                        ...
                                        <li>
                                            <button onclick="toggleModuleStatus('{{ $module->name }}', event)"
                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white w-full px-2 text-left">
