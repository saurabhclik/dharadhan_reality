                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input required autofocus name="name" value="{{ $role->name }}" type="text"
                    ...
                    <div class="p-4">
                        <div class="mb-4">
                            <input type="checkbox" id="checkPermissionAll" class="form-checkbox mr-2"
                                {{ $roleService->roleHasPermissions($role, $all_permissions) ? 'checked' : '' }}>
                        ...
                        @foreach ($permission_groups as $group)
                            <div class="mb-6">
                                <div class="flex items-center mb-2">
                                    <input type="checkbox" id="group{{ $i }}Management"
                                        class="form-checkbox mr-2"
                                        {{ $roleService->roleHasPermissions($role, $roleService->getPermissionsByGroupName($group->name)) ? 'checked' : '' }}>
