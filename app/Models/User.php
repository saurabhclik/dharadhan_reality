...
class User extends Authenticatable
{
    ...
    protected static function boot()
    {
        ...
        static::created(function ($user) {
            $sixDigits = rand(10000, 99999);
            $user->unique_id = 'DHN' . $sixDigits . $user->id;
            $user->save();
        });
    ...
    public function transferredLeads()
    {
        return $this->hasMany(Lead::class, 'transfer_user_id'); 
    }

    public function propertyReactions()
    {
